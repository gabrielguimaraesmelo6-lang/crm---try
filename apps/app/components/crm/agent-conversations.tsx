...
export function ConversationPicker({
	...
	const label = current?.title ?? "Nova conversa";
			...
			<DropdownMenu>
				...
				<DropdownMenuContent align="start" className="w-72">
					{conversations.length === 0 ? (
						<DropdownMenuItem disabled>Nada por aqui ainda</DropdownMenuItem>
					) : (
...
function Forget({
	...
	return (
		...
		>
			<Icon icon={TrashCan} />
			<span className="sr-only">Excluir esta conversa</span>
		</Button>
	);
}
