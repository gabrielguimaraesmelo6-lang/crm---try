...
const SUGGESTIONS = [
	"Avise cada proprietário de negócio antes de uma ligação de renovação",
	"Sinalize negócios sem atividade há 14 dias",
	"Repasse novos clientes de Vendas para Integração",
];
		...
		<main className="relative flex min-h-0 flex-1 flex-col items-center justify-center overflow-y-auto px-4 pt-14 pb-20 sm:px-6 sm:pt-12 sm:pb-28">
			<div className="flex w-full max-w-3xl flex-col items-center gap-3 pb-6 text-center">
				<h1 className="text-balance font-medium text-2xl tracking-tight sm:text-3xl">
					Com o que posso ajudar, {firstName(name)}?
				</h1>
				<p className="max-w-xl text-balance text-muted-foreground text-sm">
					Pergunte sobre seu CRM, marque um registro ou integração, ou descreva
					um agente para criar e automatizar uma tarefa.
				</p>
			</div>
			...
			<div className="w-full max-w-3xl">
				...
				<p className="flex h-8 items-center px-px text-muted-foreground text-xs">
					Conversas e rascunhos de agentes permanecem privados para você. Implantar
					um agente o disponibiliza para toda a equipe.
				</p>
